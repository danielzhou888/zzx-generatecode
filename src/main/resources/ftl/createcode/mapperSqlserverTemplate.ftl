...
<mapper namespace="${objectName}Mapper">
	...
	<!-- 新增-->
	<insert id="add"  parameterType="pd" useGeneratedKeys="true" keyProperty="${objectNameLower}id" parameterType="com.zzx.entity.${objectName}">
		insert into 
	...
	<!-- 修改 -->
	<update id="edit" parameterType="pd" resultType="com.zzx.entity.${objectName}">
		update
		<include refid="tableName"></include>
		set 
	<#list fieldList as var>
